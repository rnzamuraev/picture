...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])(".button-styles", ".styles-2"); // showMoreStyles(".button-styles", "#styles .row");
...
var drop = function drop(inputSelector) {
  ...
  var inputsFiles = document.querySelectorAll(inputSelector);
  ["dragenter", "dragleave", "dragover", "drop"].forEach(function (nameEvent) {
    inputsFiles.forEach(function (input) {
      input.addEventListener(nameEvent, preventDefaults, false);
    });
  });
  ...
  ["dragenter", "dragover"].forEach(function (nameEvent) {
    inputsFiles.forEach(function (input) {
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    uploads.forEach(function (upload) {
      upload.previousElementSibling.textContent = "Фаил не выбран";
    });
  };
  ...
  forms.forEach(function (form) {
    form.addEventListener("submit", function (event) {
      ...
      var formData = new FormData(form); // if (form.getAttribute("data-calc") === "calc-form") {
...
var modals = function modals() {
  ...
  function bindModal(openSelector, modalSelector, closeSelector) {
    ...
    var open = document.querySelectorAll(openSelector),
        ...
        close = document.querySelectorAll(closeSelector); // close = document.querySelector(closeSelector);
  ...
  function openByScroll(selector) {
    window.addEventListener("scroll", function () {
      if (!btnPresset && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
...
var scrolling = function scrolling(upSelector) {
  var arrowUp = document.querySelector(upSelector),
...
var sliders = function sliders(slides, next, prev, direction) {
  ...
  function activateAnimation() {
    if (direction === "vertical") {
      paused = setInterval(function () {
        plusSlide(1); // items[slideIndex - 1].classList.add("headShake");
